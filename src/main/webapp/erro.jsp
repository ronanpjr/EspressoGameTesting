...
<center>
    ...
    <%-- 2. Exibe detalhes da exceção se isErrorPage="true" foi acionado por uma exceção NÃO TRATADA --%>
    <%--    E se não houver mensagens específicas já setadas pelo controller. --%>
    <%--    Usamos pageContext.exception que é o objeto correto quando isErrorPage=true --%>

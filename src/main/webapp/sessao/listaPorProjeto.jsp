...
<%--          </td>--%>
          ...
          <td class="descricao">
            <c:set var="descCompleta" value="${sessao.descricao}"/>
            <c:set var="descResumida" value="${descCompleta}"/>
            <c:if test="${fn:length(descCompleta) > 40}">
              <c:set var="descResumida" value="${fn:substring(descCompleta, 0, 37)}..."/>
            </c:if>
            <c:out value="${descResumida}"/>
          </td>
